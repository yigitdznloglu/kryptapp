...
const commonStyles = "min-h-[70x] sm:px-0 px-2 sm:min-w-[120px] flex justify-center border-gray-400 text-sm font-light text-white";
...
const Welcome = () => {
    ...
    return (
        <div className="flex w-full justify-center items-center">
            <div className="flex mf:flex-row flex-col items-start justify-between md:pd-20 py-12 px-4">
                <div className="flex flex-1 justify-start flex-col mf:mr-10">
                    ...
                    <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
                        <div className={`text-white rounded-tl-2x1 ${commonStyles}`}>
                            Reliability
                        </div>
